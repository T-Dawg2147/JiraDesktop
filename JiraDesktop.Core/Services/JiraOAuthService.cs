...
/// <summary>
/// Handles OAuth 2.0 Authorization Code flow with Atlassian, including interactive browser-based
/// login, silent token refresh, and cloud-site ID resolution.
/// Tokens and cloud IDs are persisted to the user's local application data folder.
/// </summary>
public class JiraOAuthService : IJiraOAuthService
{
    ...
    private async Task<JiraOAuthTokenResponse> RunInteractiveLoginAsync(CancellationToken ct)
    {
        ...
        var expectedPath = redirect.AbsolutePath;
